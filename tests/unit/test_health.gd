...
func test_door_takes_damage_and_breaks() -> void:
	...
	check_eq(sounds[0][0], &"door_bang", "bang sound category")
	check_near(sounds[0][1], 12.0, 0.001, "bang radius 12 m recruits")
	check_eq(sounds[-1][0], &"door_break", "break sound category")
